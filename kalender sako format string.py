...
def name_day(b):
    ...
    #list=["Monday", "Monday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"]
    return list[b-1]
...
def calendar (year):
    ...
    the last day of the month and the last day of the week as week, to then place it appropriately in the printed line"""
    kalenderweek=0
    for i in range (1,13):
        ...
        for j in range(1, days_in_month(i, year)+1):
            if teller==0:
                ...
                print('02d',{} . format(kalenderweek), end=" ")
                ...
                print('%2d' % (j), end="  ")
                teller+=1
            if j==days_in_month(i, year) and week_day(j,i,year)!=6:
                print ("\n ")
