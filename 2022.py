...
def days_in_month(month, year2):
    ...
    *is checking in which one of the two lists the month is in and returning 31 or 30, unless of course the given month is February in which case
...
def calendar(year):
    ...
    *or the last day of the month and the last day of the week as week, to then place it appropriately in the printed line"""
    kalenderweek = 0
    for i in range(1, 13):
